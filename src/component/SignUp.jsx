  ...
  return (
    <div className="bg-slate-600 md:pt-28  pt-20 h-[100vh]">
        ...
        <div className="flex flex-col md:mx-44 mx-6 my-2">
              ...
              <input type="text" className="bg-white py-2 px-2 rounded-md outline-none border-2 border-solid boder-slate-300"  name="name" id="name" placeholder='Enter your name'/>  
        </div>
        <div className="flex flex-col md:mx-44 mx-6 my-2">
